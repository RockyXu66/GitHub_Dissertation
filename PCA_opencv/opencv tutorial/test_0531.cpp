...
////  PCA_opencv
////
////  Created by Yinghan Xu on 31/05/2017.
...
//    {
//        return;
//    } //设置光栅位置 glRasterPos2i(0, 0); //修改的图像，和用于反转的映射数组 GLbyte *pModifyImage = NULL;
//    
...
//            return;
//        }
//            //从颜色缓冲区中读取图像的亮度数据 glReadPixels(0, 0, iWidth, iHeight, GL_LUMINANCE, GL_UNSIGNED_BYTE, pModifyImage);
//            //还原 glPixelTransferf(GL_RED_SCALE, 1.0f);
//            glPixelTransferf(GL_GREEN_SCALE, 1.0f);
//            glPixelTransferf(GL_BLUE_SCALE, 1.0f); break;
//        case 8:
//            //设置反转的颜色映射 invertMap[0] = 1.0f; for(int i = 0; i < 256; ++i)
//        {
...
//            //开启颜色映射 glPixelTransferi(GL_MAP_COLOR, GL_TRUE); default: break;
//    }
//    if (pModifyImage)
...
//    //设置像素的存储格式 glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
//    //加载图像数据 pImage = gltLoadTGA("horse.tga", &iWidth, &iHeight, &iComponents, &eFormat);
//    
