...
//  opencv tutorial
//
//  Created by Yinghan Xu on 14/07/2017.
//  Copyright © 2017 Yinghan Xu. All rights reserved.
//

// Source code from https://gist.github.com/Bibimaw/8873663

#include "SSIM&PSNR.hpp"
...
//        resize(frame,frame,Size(720,720));
//        imwrite("soliderRecord/solider_"+to_string(i)+".png", frame);
//        imshow("edges", frame);
