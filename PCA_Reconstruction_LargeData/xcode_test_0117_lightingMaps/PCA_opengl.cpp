...
// Camera
Camera camera(vec3(-0.1f, 0.0f, 1.9f));
bool keys[1024];
...
GLuint planeVAO;
GLuint testTime1, testTime2, duration;
...
int main()
{
    ...
    //Load textures
    floorTexture = loadTexture("../../Data_Set/artifix_120x_png/artifix0001.png");
    testTexture = loadTexture("../../Data_Set/artifix_120x_png/artifix0001.png");
    ...
    for(int i=0; i<image_num; i++){
        string filename;
//        filename = "../../Data_Set/training_set_head/fig_1.bmp";
        if(i<9){
            filename = "../../Data_Set/artifix_120x_png/artifix000"+to_string(i+1)+".png";
        }else if(i>=9&&i<99){
            filename = "../../Data_Set/artifix_120x_png/artifix00"+to_string(i+1)+".png";
        }else if(i>=99){
            filename = "../../Data_Set/artifix_120x_png/artifix0"+to_string(i+1)+".png";
        }
    ...
    cout<<"Finish to load images"<<endl;
    testTime2 = glfwGetTime();
    duration = testTime2 - testTime1;
    cout<<"Images loading time: "<<endl;
    ...
    // PCA
    PCA_ pca;
    string filename = "../../Data_Set/artifix_120x_png/artifix0001.png";
    unsigned char* newImage = pca.CalculateEigen(images, image_num, image_width, image_height);
