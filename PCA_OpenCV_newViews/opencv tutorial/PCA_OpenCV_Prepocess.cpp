...
//            Mat scoreR = scores_r(Rect(0,imageIndex*cell_num+j+i*y,num_components,1));
            ...
            Mat scoreB = (scores_b(Rect(0,imageIndex*cell_num+j+i*y,num_components,1))+scores_b(Rect(0,(imageIndex+1)*cell_num+j+i*y,num_components,1)))/2.0;
            Mat scoreG = (scores_g(Rect(0,imageIndex*cell_num+j+i*y,num_components,1))+scores_g(Rect(0,(imageIndex+1)*cell_num+j+i*y,num_components,1)))/2.0;
            Mat scoreR = (scores_r(Rect(0,imageIndex*cell_num+j+i*y,num_components,1))+scores_r(Rect(0,(imageIndex+1)*cell_num+j+i*y,num_components,1)))/2.0;
...
//    split(imread(oneImagePath), mean_bgr);
    reconstruction(cell_num, bgr, bgr);
