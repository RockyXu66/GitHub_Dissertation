...
String oneImagePath = "/Users/yinghanxu/Study/Dissertation_ResultData/Data_Set/soliderRecord_run/solider_11.png";

String m_name = to_string(smallerNum)+"_cells"+to_string(cell_dimension);
String d_name = "solider_run";
...
void reconstructionAllImages(int cell_num, Mat bgr[3], int num_components){
    ...
    for(int i=0; i<image_num; i++){
        ...
        if(isSmoothed){
            imwrite("/Users/yinghanxu/Study/Dissertation_ResultData/Data_Set/ResultImages_Smoothed/solider_run("+to_string(image_width)+")_cell"+to_string(cell_dimension)+"_"+to_string(num_components)+"/solider_run"+to_string(imageIndex+1)+".png", resultImage);
        }else{
            imwrite("/Users/yinghanxu/Study/Dissertation_ResultData/Data_Set/ResultImages/solider_run("+to_string(image_width)+")_cell"+to_string(cell_dimension)+"_"+to_string(num_components)+"/solider_run"+to_string(imageIndex+1)+".png", resultImage);
        }
        cout<<i+1<<" ";
    }
    cout<<endl;
...
//    calculatePCA(cell_num);
    ...
    reconstructionAllImages(cell_num, bgr, 13);
    reconstructionAllImages(cell_num, bgr, 16);
    reconstructionAllImages(cell_num, bgr, 19);
//    reconstructionAllImages(cell_num, bgr, 40);
//    reconstructionAllImages(cell_num, bgr, 45);
