...
String oneImagePath = "/Users/yinghanxu/Study/Dissertation_ResultData/Data_Set/soliderRecord_run/solider_1.png";
    ...
    for(int i=0; i<image_height/cell_dimension; i++){
        ...
        for(int j=0; j<image_width/cell_dimension; j++){
            ...
            for(int n=0; n<image_num; n++){
                Mat img = imread("/Users/yinghanxu/Study/Dissertation_ResultData/Data_Set/soliderRecord_run/solider_"+to_string(n+1)+".png");
